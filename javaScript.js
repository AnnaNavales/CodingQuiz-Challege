...
var correct;
// this function cycle 
function generatedQuizQuestion() {
...
function startQuiz(){
    ...
    function showScore(){
        ...
        finalScoreEl.innerHTML = "You have + score +"out of" + quizQuestion.Length
        +"correct!";
    }
...
submitScoreButton.addEventLister("click, function highScore"(){
    if(highScoreInputName.value==="") {
        ...
        function clearScore(){
            ...
            HighScoreDispalyname.text content ="";
            HighScoreDisplayScore.text content ="";
            ...
            function replayQuiz (){
                ...
                alert ("that is correct") generateQuiz 
                generatedQuizQuestion();
